  ...
  //声明一个对象
    ...
    for (var i = 1; i < 92; i++) {
      //得到一个日期
        ...
        //填充对象，属性：属性值，Math.random()是令系统随机选取大于等于 0.0 且小于 1.0 的伪随机 double 值
